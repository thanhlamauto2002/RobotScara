function set_joints_params(scara, handles)
    ...
    set(handles.q1value, 'String', num2str(rad2deg(scara.theta(2))));
    set(handles.q2value, 'String', num2str(rad2deg(scara.theta(3))));
    set(handles.q3value, 'String', num2str(scara.d(4)));
    set(handles.q4value, 'String', num2str(rad2deg(scara.theta(5))));
